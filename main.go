...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	speed := r.meanSpeed()
	return ((CaloriesMeanSpeedMultiplier*speed + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours())
}
...
func (w Walking) Calories() float64 {
	...
	speedCalories := (math.Pow(speedInMsec, 2) / heightInM) * CaloriesSpeedHeightMultiplier * w.Weight

	totalCalories := (weightCalories + speedCalories) * w.Duration.Minutes()
